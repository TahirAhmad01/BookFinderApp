  ...
  return (
    <div className="main-details mb-8 flex flex-col md:flex-row">
      <div className="w-full md:w-1/3 mb-4 md:mb-0 flex justify-center overflow-hidden">
        <div className="mt-6 w-full max-w-[300px] h-[500px] bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
      </div>

      <div className="w-full md:w-2/3 pl-4 flex flex-col justify-center items-center">
        <div className="w-3/4 h-8 bg-gray-200 dark:bg-gray-700 animate-pulse mb-4"></div>
              ...
              {Array(6)
                ...
                .map((_, index) => (
                  ...
                  >
                    <th
                      scope="row"
                      className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap bg-gray-50 dark:bg-gray-800 w-1/3"
                    >
                      <div className="w-24 h-6 bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
                    </th>
                    <td className="px-6 py-4 w-2/3">
                      <div className="w-full h-6 bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
                    </td>
                  </tr>
                ))}
            </tbody>
